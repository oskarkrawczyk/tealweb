...
class Filter {
  ...
  buildGallery(products){
    ...
    products.forEach((product) => {
      output.push(`<li>
        <a class="tile" href="//cdn.byteal.pl/puma-4/${product.Index}.jpg">
          <img src="//cdn.byteal.pl/puma-4/${product.Index}.jpg" loading="lazy">
          <h3>${product.Nazwa}</h3>
          <section>
            <em>${product.Index}</em>
        ...
        <a title="Ściągnij zdjęcie" class="download" href="//cdn.byteal.pl/puma-4/${product.Index}.jpg">
